...
*/
/* Segmente 1-14, Helligkeit der Farben ROT, GRUEN, BLAU
...
digitalWrite(bahnGRUENout, LOW);
  ...
  pixels.setPixelColor(13, pixels.Color(0, 100, 0));
...
digitalWrite(bahnGRUENout, LOW);
  ...
  pixels.setPixelColor(6, pixels.Color(0, 0, 0));
  pixels.setPixelColor(7, pixels.Color(100, 100, 0));
  pixels.setPixelColor(8, pixels.Color(0, 0, 0));
  pixels.setPixelColor(9, pixels.Color(100, 100, 0));
  pixels.setPixelColor(10, pixels.Color(0, 0, 0));
  pixels.setPixelColor(11, pixels.Color(100, 100, 0));
  pixels.setPixelColor(12, pixels.Color(0, 0, 0));
  pixels.setPixelColor(13, pixels.Color(100, 100, 0));
  pixels.setPixelColor(14, pixels.Color(0, 0, 0));
    pixels.show();
    delay(200);
pixels.setPixelColor(0, pixels.Color(100, 100, 0));
  ...
  pixels.setPixelColor(5, pixels.Color(0, 0, 0));
  pixels.setPixelColor(6, pixels.Color(100, 100, 0));
  pixels.setPixelColor(7, pixels.Color(0, 0, 0));
  pixels.setPixelColor(8, pixels.Color(100, 100, 0));
  pixels.setPixelColor(9, pixels.Color(0, 0, 0));
  pixels.setPixelColor(10, pixels.Color(100, 100, 0));
  pixels.setPixelColor(11, pixels.Color(0, 0, 0));
  pixels.setPixelColor(12, pixels.Color(100, 100, 0));
  pixels.setPixelColor(13, pixels.Color(0, 0, 0));
  pixels.setPixelColor(14, pixels.Color(100, 100, 0));
    pixels.show();
    delay(200);
    } 
    }
...
digitalWrite(bahnGRUENout, LOW);
  ...
  pixels.setPixelColor(12, pixels.Color(0, 0, 0));
  pixels.setPixelColor(13, pixels.Color(0, 0, 100));
  pixels.setPixelColor(14, pixels.Color(0, 0, 0));
    pixels.show();
    delay(200);
pixels.setPixelColor(0, pixels.Color(0, 0, 100));
  ...
  pixels.setPixelColor(9, pixels.Color(0, 0, 0));
  pixels.setPixelColor(10, pixels.Color(0, 0, 100));
  pixels.setPixelColor(11, pixels.Color(0, 0, 0));
  pixels.setPixelColor(12, pixels.Color(0, 0, 100));
  pixels.setPixelColor(13, pixels.Color(0, 0, 0));
  pixels.setPixelColor(14, pixels.Color(0, 0, 100));
    pixels.show();
    delay(200);
    } 
    }
